...
if [ "$SSH_CONFIGURED" = true ]; then
    ...
    echo "   make pull"
    echo ""
    echo "2. Start creating automations!"
else
    echo "1. Complete SSH setup (see instructions above)"
    echo "2. Pull your actual configuration: make pull"
    echo "3. Start creating automations!"
fi
echo ""
echo "🚀 Using Hermes Agent?"
echo "   See HERMES.md for skill-specific setup instructions."
echo ""
echo "For detailed instructions, see the README.md file."
echo ""
echo "Need help? Check the troubleshooting section in README.md"
echo "or create an issue at: https://github.com/gwyntel/hermes-homeassistant/issues"
